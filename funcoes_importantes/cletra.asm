...
;
;====================================================================
;	- Escrever um programa para contar o n�mero de letras de um 
;		arquivo.
;	- O usu�rio devem informar o nome do arquivo, assim que for
...
Continua2:
	...
	;		}
	cmp		ax,0
	jne		Continua3	;não terminou o arquivo

	;se leu e terminou zera A
	mov		al,0
	jmp		CloseAndFinal
Continua3:
